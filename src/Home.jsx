...
const MAP_FILTERS = [
  { label: 'Total Population', value: 'TOTAL' }, // Default view
        ...
        <div className="w-full max-w-4xl mb-6 flex flex-col md:flex-row items-center justify-between bg-white p-4 rounded-lg shadow-sm border border-gray-200 gap-4">
          ...
          <div className="flex space-x-4">
            ...
            <select
              ...
              className="block w-48 px-3 py-2 text-sm border-gray-300 rounded-md border bg-gray-50 focus:ring-blue-500"
            >
